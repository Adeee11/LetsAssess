...
const Dashboard = () => {
    ...
    return (
        ...
        <>
            ...
            <Header>
                {show.showAllTest && <li>
                    <span onClick={() => setShow({ showSubmission: false, showAllTest: false, showAllCandidates: true })}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-left" viewBox="0 0 16 16">
                            <path fillRule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                        </svg>
                    </span>
                </li>}
                {show.showSubmission && <li>
                    <span onClick={() => setShow({ showSubmission: false, showAllTest: true, showAllCandidates: false })}>
            ...
            <Container>
                ...
                {show.showAllCandidates &&
                    allCandidates.map((candidate) => <Card key={candidate.email} onClick={() => clickHandler(candidate)}>
            ...
            <Container>
                ...
                {show.showAllTest && candidateData &&
                    ...
                    candidateData.map((test) => <Card key={test.assessmentId} onClick={() => showPaper(test.assessmentId, test.marksObtained)}>
                        ...
                        <img src={imageSrc(test.assessmentId)} alt=""/>
